...
public class Painter {
    ...
    public void paintTrack(float pXpos, float pWidth, float pHeight, boolean barrier) {
        ...
        context.setFill(Color.color(0.01, 0.3, 0.01));
        if (barrier) {
            context.fillRect(pXpos, pHeight / 2 - 5, pWidth, 10);
        }
    }
